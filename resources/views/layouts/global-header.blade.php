    ...
    <form>
      ...
      <button type="submit"
        class="focus:outline-none text-white bg-green-700 hover:bg-green-800 
			focus:ring-4 focus:ring-green-300 font-midium rounded-lg text-sm px-5 py-2.5 ml-2">検索</button>
    </form>
    <a href="{{ route('recipe.create') }}"
      class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 
		focus:ring-green-300 font-medium rounded text-sm px-5 py-2.5">レシピ投稿</a>
  </div>
</section>
